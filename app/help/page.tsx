...
const COMPLAINTS: Complaint[] = [
  ...
  { code: 'BURNS', label: 'Burns', emoji: '🔥', tier: 1, dispatchNote: 'Burn injury — critical' },
  { code: 'ALLERGIC', label: 'Severe allergic reaction', emoji: '🤧', tier: 1, dispatchNote: 'Anaphylaxis risk' },
  ...
  { code: 'DIABETIC', label: 'Diabetic emergency', emoji: '🍬', tier: 1, dispatchNote: 'Diabetic crisis — check blood sugar' },
  { code: 'ASTHMA', label: 'Asthma attack', emoji: '🌬️', tier: 2, dispatchNote: 'Asthma — check inhaler access' },
  { code: 'ANXIETY', label: 'Anxiety or panic', emoji: '😰', tier: 2, dispatchNote: 'Anxiety / panic episode' },
  { code: 'MEDICATION', label: 'Need medication', emoji: '💊', tier: 2, dispatchNote: 'Medication access needed' },
